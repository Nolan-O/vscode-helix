...
export function loadDefaultConfig() {
  ...
  addBinding(
    [actionFuncs.delete_char_backward],
    [
  ...
  addBinding(
    [actionFuncs.vs_search_backspace],
    [
      [Mode.SearchInProgress, ['backspace']],
      [Mode.Select, ['backspace']],
    ],
  );
  addBinding(
    [actionFuncs.vs_search_paste],
    [
      [Mode.SearchInProgress, ['ctrl', 'v']],
      [Mode.Select, ['ctrl', 'v']],
    ],
  );
  ...
  addBinding(
    [actionFuncs.repeat_last_motion],
    [
      [Mode.Normal, ['alt', '.']],
      [Mode.Visual, ['alt', '.']],
      [Mode.VisualLine, ['alt', '.']],
  ...
  addBinding(
    ...
    [
      ...
      [Mode.Visual, ['ctrl', 'b']],
      [Mode.Visual, ['pageup']],
      [Mode.VisualLine, ['ctrl', 'b']],
      [Mode.VisualLine, ['pageup']],
    ],
  );
  addBinding(
    [actionFuncs.page_down],
    [
      [Mode.Normal, ['ctrl', 'f']],
      [Mode.Normal, ['pagedown']],
      [Mode.Visual, ['ctrl', 'f']],
      [Mode.Visual, ['pagedown']],
      [Mode.VisualLine, ['ctrl', 'f']],
      [Mode.VisualLine, ['pagedown']],
    ],
  );
  addBinding(
    [actionFuncs.page_up],
    [
      [Mode.Normal, ['g', 'pageup']],
      [Mode.Visual, ['g', 'pageup']],
    ],
  );
  addBinding(
    [actionFuncs.page_down],
    [
      [Mode.Normal, ['g', 'pagedown']],
      [Mode.Visual, ['g', 'pagedown']],
    ],
  );
  addBinding(
    [actionFuncs.page_cursor_half_up],
    [
      [Mode.Normal, ['ctrl', 'u']],
      [Mode.Visual, ['ctrl', 'u']],
    ],
  ...
  addBinding(
    [actionFuncs.page_cursor_half_down],
    [
      [Mode.Normal, ['ctrl', 'd']],
      [Mode.Visual, ['ctrl', 'd']],
    ],
  ...
  addBinding(
    [actionFuncs.split_selection_on_newline],
    [
      [Mode.Normal, ['alt', 's']],
      [Mode.Visual, ['alt', 's']],
    ],
  ...
  */
  ...
  addBinding(
    [actionFuncs.insert_at_line_start],
    [
      [Mode.Normal, ['shift', 'i']],
      [Mode.Visual, ['shift', 'i']],
    ],
  ...
  addBinding(
    [actionFuncs.insert_at_line_end],
    [
      [Mode.Normal, ['shift', 'a']],
      [Mode.Visual, ['shift', 'a']],
    ],
  ...
  addBinding(
    [actionFuncs.keep_primary_selection],
    [
      [Mode.Normal, [',']],
      [Mode.Visual, [',']],
    ],
  ...
  addBinding(
    [actionFuncs.open_above],
    [
      [Mode.Normal, ['shift', 'o']],
      [Mode.Visual, ['shift', 'o']],
      [Mode.VisualLine, ['shift', 'o']],
    ],
  );
  addBinding(
    [actionFuncs.undo],
  ...
  addBinding(
    ...
    [
      [Mode.Normal, ['shift', 'u']],
      [Mode.Visual, ['shift', 'u']],
      [Mode.VisualLine, ['shift', 'u']],
    ],
  );
  addBinding(
    [actionFuncs.extend_line_below],
    [
      [Mode.Normal, ['x']],
      [Mode.Visual, ['x']],
    ],
  ...
  addBinding(
    [actionFuncs.extend_to_line_bounds],
    [
      [Mode.Normal, ['shift', 'x']],
      [Mode.Visual, ['shift', 'x']],
    ],
  ...
  addBinding(
    [actionFuncs.shrink_to_line_bounds],
    [
      [Mode.Normal, ['alt', 'x']],
      [Mode.Visual, ['alt', 'x']],
    ],
  ...
  addBinding(
    [actionFuncs.collapse_selection],
    [
      [Mode.Normal, [';']],
      [Mode.Visual, [';']],
    ],
  ...
  addBinding(
    [actionFuncs.change_selection_noyank],
    [
      [Mode.Normal, ['alt', 'c']],
      [Mode.Visual, ['alt', 'c']],
      [Mode.VisualLine, ['alt', 'c']],
    ],
  );
  addBinding(
    [actionFuncs.delete_selection],
    [
      [Mode.Normal, ['d']],
      [Mode.Visual, ['d']],
      [Mode.VisualLine, ['d']],
  ...
  addBinding(
    [actionFuncs.delete_selection_noyank],
    [
      [Mode.Normal, ['alt', 'd']],
      [Mode.Visual, ['alt', 'd']],
      [Mode.VisualLine, ['alt', 'd']],
    ],
  );
  addBinding(
    [actionFuncs.replace_with_yanked],
    [
      [Mode.Normal, ['shift', 'r']],
      [Mode.Visual, ['shift', 'r']],
      [Mode.VisualLine, ['shift', 'r']],
    ],
  );

  addBinding(
    [actionFuncs.find_till_char],
    [
      [Mode.Normal, ['t']],
      [Mode.Visual, ['t']],
    ],
  ...
  addBinding(
    [actionFuncs.shrink_selection],
    [
      [Mode.Normal, ['alt', 'i']],
      [Mode.Normal, ['alt', 'down']],
    ],
  );
  addBinding(
    [actionFuncs.command_mode],
    [
      [Mode.Normal, ['shift', ';']],
      [Mode.Select, ['shift', ';']],
      [Mode.Window, ['shift', ';']],
  ...
  */
  ...
  addBinding(
    [actionFuncs.move_visual_line_up],
    [
      [Mode.Normal, ['k']],
      [Mode.Visual, ['k']],
      [Mode.VisualLine, ['k']],
  ...
  addBinding(
    [actionFuncs.move_visual_line_down],
    [
      [Mode.Normal, ['j']],
      [Mode.Visual, ['j']],
      [Mode.VisualLine, ['j']],
  ...
  addBinding(
    [actionFuncs.move_next_word_start],
    [
      [Mode.Normal, ['w']],
      [Mode.Visual, ['w']],
      [Mode.VisualLine, ['w']],
  ...
  addBinding(
    [actionFuncs.move_next_long_word_start],
    [
      [Mode.Normal, ['shift', 'w']],
      [Mode.Visual, ['shift', 'w']],
      [Mode.VisualLine, ['shift', 'w']],
    ],
  );
  addBinding(
    [actionFuncs.move_prev_word_start],
    [
      [Mode.Normal, ['b']],
      [Mode.Visual, ['b']],
      [Mode.VisualLine, ['b']],
  ...
  addBinding(
    [actionFuncs.move_prev_long_word_start],
    [
      [Mode.Normal, ['shift', 'b']],
      [Mode.Visual, ['shift', 'b']],
      [Mode.VisualLine, ['shift', 'b']],
    ],
  );
  addBinding(
    [actionFuncs.move_next_word_end],
    [
      [Mode.Normal, ['e']],
      [Mode.Visual, ['e']],
      [Mode.VisualLine, ['e']],
  ...
  addBinding(
    [actionFuncs.move_next_long_word_end],
    [
      [Mode.Normal, ['shift', 'e']],
      [Mode.Visual, ['shift', 'e']],
      [Mode.VisualLine, ['shift', 'e']],
    ],
  );
  ...
  */
  ...
  addBinding(
    [actionFuncs.goto_first_nonwhitespace],
    [
      [Mode.Normal, ['g', 's']],
      [Mode.Visual, ['g', 's']],
    ],
  ...
  addBinding(
    [actionFuncs.goto_window_center],
    [
      [Mode.Normal, ['g', 'c']],
      [Mode.Visual, ['g', 'c']],
      [Mode.VisualLine, ['g', 'c']],
  ...
  addBinding(
    [actionFuncs.goto_window_bottom],
    [
      [Mode.Normal, ['g', 'b']],
      [Mode.Visual, ['g', 'b']],
      [Mode.VisualLine, ['g', 'b']],
  ...
  */
  ...
  addBinding(
    [actionFuncs.goto_next_paragraph],
    [
      [Mode.Normal, [']', 'p']],
      [Mode.Visual, [']', 'p']],
      [Mode.VisualLine, [']', 'p']],
  ...
  addBinding(
    [actionFuncs.goto_prev_paragraph],
    [
      [Mode.Normal, ['[', 'p']],
      [Mode.Visual, ['[', 'p']],
      [Mode.VisualLine, ['[', 'p']],
