...
export function activate(context: vscode.ExtensionContext): void {
  context.subscriptions.push(
    ...
    commands.registerCommand("extension.helixKeymap.pageup", () => { globalhelixState.typeSubscription(globalhelixState, "pageup"); }),
    commands.registerCommand("extension.helixKeymap.pagedown", () => { globalhelixState.typeSubscription(globalhelixState, "pagedown"); }),
    commands.registerCommand("extension.helixKeymap.home", () => { globalhelixState.typeSubscription(globalhelixState, "home"); }),
    ...
    commands.registerCommand("extension.helixKeymap.ctrl_;", () => { pushKP(["ctrl"]); globalhelixState.typeSubscription(globalhelixState, ";"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_squote", () => { pushKP(["ctrl"]); globalhelixState.typeSubscription(globalhelixState, "'"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_,", () => { pushKP(["ctrl"]); globalhelixState.typeSubscription(globalhelixState, ","); }),
    commands.registerCommand("extension.helixKeymap.ctrl_.", () => { pushKP(["ctrl"]); globalhelixState.typeSubscription(globalhelixState, "."); }),
    commands.registerCommand("extension.helixKeymap.ctrl_/", () => { pushKP(["ctrl"]); globalhelixState.typeSubscription(globalhelixState, "/"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_bslash", () => { pushKP(["ctrl"]); globalhelixState.typeSubscription(globalhelixState, "\\"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_eq", () => { pushKP(["ctrl"]); globalhelixState.typeSubscription(globalhelixState, "="); }),
    commands.registerCommand("extension.helixKeymap.ctrl_-", () => { pushKP(["ctrl"]); globalhelixState.typeSubscription(globalhelixState, "-"); }),
    ...
    commands.registerCommand("extension.helixKeymap.alt_;", () => { pushKP(["alt"]); globalhelixState.typeSubscription(globalhelixState, ";"); }),
    commands.registerCommand("extension.helixKeymap.alt_squote", () => { pushKP(["alt"]); globalhelixState.typeSubscription(globalhelixState, "'"); }),
    commands.registerCommand("extension.helixKeymap.alt_,", () => { pushKP(["alt"]); globalhelixState.typeSubscription(globalhelixState, ","); }),
    commands.registerCommand("extension.helixKeymap.alt_.", () => { pushKP(["alt"]); globalhelixState.typeSubscription(globalhelixState, "."); }),
    commands.registerCommand("extension.helixKeymap.alt_/", () => { pushKP(["alt"]); globalhelixState.typeSubscription(globalhelixState, "/"); }),
    commands.registerCommand("extension.helixKeymap.alt_bslash", () => { pushKP(["alt"]); globalhelixState.typeSubscription(globalhelixState, "\\"); }),
    commands.registerCommand("extension.helixKeymap.alt_eq", () => { pushKP(["alt"]); globalhelixState.typeSubscription(globalhelixState, "="); }),
    commands.registerCommand("extension.helixKeymap.alt_-", () => { pushKP(["alt"]); globalhelixState.typeSubscription(globalhelixState, "-"); }),
    ...
    commands.registerCommand("extension.helixKeymap.shift_;", () => { pushKP(["shift"]); globalhelixState.typeSubscription(globalhelixState, ";"); }),
    commands.registerCommand("extension.helixKeymap.shift_squote", () => { pushKP(["shift"]); globalhelixState.typeSubscription(globalhelixState, "'"); }),
    commands.registerCommand("extension.helixKeymap.shift_,", () => { pushKP(["shift"]); globalhelixState.typeSubscription(globalhelixState, ","); }),
    commands.registerCommand("extension.helixKeymap.shift_.", () => { pushKP(["shift"]); globalhelixState.typeSubscription(globalhelixState, "."); }),
    commands.registerCommand("extension.helixKeymap.shift_/", () => { pushKP(["shift"]); globalhelixState.typeSubscription(globalhelixState, "/"); }),
    commands.registerCommand("extension.helixKeymap.shift_bslash", () => { pushKP(["shift"]); globalhelixState.typeSubscription(globalhelixState, "\\"); }),
    commands.registerCommand("extension.helixKeymap.shift_eq", () => { pushKP(["shift"]); globalhelixState.typeSubscription(globalhelixState, "="); }),
    commands.registerCommand("extension.helixKeymap.shift_-", () => { pushKP(["shift"]); globalhelixState.typeSubscription(globalhelixState, "-"); }),
    ...
    commands.registerCommand("extension.helixKeymap.ctrl_alt_;", () => { pushKP(["ctrl", "alt"]); globalhelixState.typeSubscription(globalhelixState, ";"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_alt_squote", () => { pushKP(["ctrl", "alt"]); globalhelixState.typeSubscription(globalhelixState, "'"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_alt_,", () => { pushKP(["ctrl", "alt"]); globalhelixState.typeSubscription(globalhelixState, ","); }),
    commands.registerCommand("extension.helixKeymap.ctrl_alt_.", () => { pushKP(["ctrl", "alt"]); globalhelixState.typeSubscription(globalhelixState, "."); }),
    commands.registerCommand("extension.helixKeymap.ctrl_alt_/", () => { pushKP(["ctrl", "alt"]); globalhelixState.typeSubscription(globalhelixState, "/"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_alt_bslash", () => { pushKP(["ctrl", "alt"]); globalhelixState.typeSubscription(globalhelixState, "\\"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_alt_eq", () => { pushKP(["ctrl", "alt"]); globalhelixState.typeSubscription(globalhelixState, "="); }),
    commands.registerCommand("extension.helixKeymap.ctrl_alt_-", () => { pushKP(["ctrl", "alt"]); globalhelixState.typeSubscription(globalhelixState, "-"); }),
    ...
    commands.registerCommand("extension.helixKeymap.ctrl_shift_;", () => { pushKP(["ctrl", "shift"]); globalhelixState.typeSubscription(globalhelixState, ";"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_squote", () => { pushKP(["ctrl", "shift"]); globalhelixState.typeSubscription(globalhelixState, "'"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_,", () => { pushKP(["ctrl", "shift"]); globalhelixState.typeSubscription(globalhelixState, ","); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_.", () => { pushKP(["ctrl", "shift"]); globalhelixState.typeSubscription(globalhelixState, "."); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_/", () => { pushKP(["ctrl", "shift"]); globalhelixState.typeSubscription(globalhelixState, "/"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_bslash", () => { pushKP(["ctrl", "shift"]); globalhelixState.typeSubscription(globalhelixState, "\\"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_eq", () => { pushKP(["ctrl", "shift"]); globalhelixState.typeSubscription(globalhelixState, "="); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_-", () => { pushKP(["ctrl", "shift"]); globalhelixState.typeSubscription(globalhelixState, "-"); }),
    ...
    commands.registerCommand("extension.helixKeymap.shift_alt_;", () => { pushKP(["shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, ";"); }),
    commands.registerCommand("extension.helixKeymap.shift_alt_squote", () => { pushKP(["shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, "'"); }),
    commands.registerCommand("extension.helixKeymap.shift_alt_,", () => { pushKP(["shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, ","); }),
    commands.registerCommand("extension.helixKeymap.shift_alt_.", () => { pushKP(["shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, "."); }),
    commands.registerCommand("extension.helixKeymap.shift_alt_/", () => { pushKP(["shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, "/"); }),
    commands.registerCommand("extension.helixKeymap.shift_alt_bslash", () => { pushKP(["shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, "\\"); }),
    commands.registerCommand("extension.helixKeymap.shift_alt_eq", () => { pushKP(["shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, "="); }),
    commands.registerCommand("extension.helixKeymap.shift_alt_-", () => { pushKP(["shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, "-"); }),
    ...
    commands.registerCommand("extension.helixKeymap.ctrl_shift_alt_;", () => { pushKP(["ctrl", "shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, ";"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_alt_squote", () => { pushKP(["ctrl", "shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, "'"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_alt_,", () => { pushKP(["ctrl", "shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, ","); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_alt_.", () => { pushKP(["ctrl", "shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, "."); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_alt_/", () => { pushKP(["ctrl", "shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, "/"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_alt_bslash", () => { pushKP(["ctrl", "shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, "\\"); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_alt_eq", () => { pushKP(["ctrl", "shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, "="); }),
    commands.registerCommand("extension.helixKeymap.ctrl_shift_alt_-", () => { pushKP(["ctrl", "shift", "alt"]); globalhelixState.typeSubscription(globalhelixState, "-"); }),
